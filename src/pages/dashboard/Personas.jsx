                    ...
                    <table className='w-full mt-4 text-center border-collapse table-auto'>
                        ...
                        <tbody>
                            {personas.map(persona => (
                                <tr key={persona.id} className='cursor-pointer odd:bg-white even:bg-gray-100 dark:odd:bg-gray-800 dark:even:bg-gray-900 hover:bg-gray-300 dark:hover:bg-gray-700' onClick={() => handlePersonaClick(persona.id)}>
