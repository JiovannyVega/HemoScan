                ...
                <section class="bg-[url('./src/assets/NHP.png')] bg-center w-full h-96">
                    ...
                    <div>
                        ...
                        <div class="flex justify-center">
                            <Link to="" class="m-2 p-4 rounded-md cursor-pointer bg-sky-950 text-white">Iniciar Sesion</Link>
                            <Link to="" class="m-2 p-4 rounded-md cursor-pointer bg-sky-950 text-white">Crear Cuenta</Link>
                        </div>
                    </div>
                </section>
                <div class="flex flex-col bg-gray-100 m-0 p-0 w-4/5 items-center">
                    <section class="text-center w-3/5 mt-20 text-black">
                    ...
                    <section class="w-3/5 mt-18 text-black">
